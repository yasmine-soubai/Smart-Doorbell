...
<body>
        ...
        <div class="home-container">
            ...
            <div class="home-text-container">
                <form method="get" action="index.php">
    				...
    				<input type="submit" style="font-size: 14 pt" value="OFF" name="off_speaker">
    ...
    <div class="img-pane">
        ...
        <img src="http://192.168.1.11/images/person.jpg" name="Person" srcset=" http://192.168.1.11/images/person.jpg 9000w, http://192.168.1.11/images/person.jpg 5000w" sizes="(min-width: 36em) 33.3vw, 100vw"> </img>
    </div>
		<!--    
            <?php
                shell_exec("/usr/local/bin/gpio -g mode 27 out");
                shell_exec("/usr/local/bin/gpio -g mode 22 out");
                if(isset($_GET['off_door'])) {
                    echo "Door is closed";
                    shell_exec("/usr/local/bin/gpio -g write 27 0");
                } else if(isset($_GET['on_door'])) {
                    echo "Door is open";
                    shell_exec("/usr/local/bin/gpio -g write 27 1");
                    sleep(2); <!--add-->
                    shell_exec("/usr/local/bin/gpio -g write 27 0");<!--add-->
                } else if(isset($_GET['off_speaker'])) {
                    echo "Speaker is off";
